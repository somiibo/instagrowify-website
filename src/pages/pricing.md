...
pricing:
  ...
  definitions:
    ...
    - id: "profiles"
      definition: "Profiles are separate Instagram accounts or browser sessions you can automate."
    - id: "runtime"
...
testimonials:
  ...
  items:
    - quote: "The Pro plan is perfect for my needs. I've grown from 5K to 50K followers!"
      author: "Sarah Kim"
...
faqs:
  ...
  items:
    ...
    - question: "Is my Instagram account safe?"
      answer: "Yes! {{ site.brand.name }} uses human-like behavior patterns, smart rate limiting, and follows Instagram's guidelines. We've helped 500K+ users grow safely."
    - question: "What are modules and profiles?"
      answer: "Modules are automation tasks (like following, liking, commenting) that run simultaneously. Profiles are separate Instagram accounts you can manage. More modules = faster growth!"
