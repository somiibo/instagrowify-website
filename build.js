(function() {
  ...
  const config = {
  "timestamp": "2025-12-03T04:43:18.988Z",
  "repo": {
    "user": "somiibo",
    "name": "instagrowify-website"
  },
  "environment": "production",
  "packages": {
    "web-manager": "4.0.30",
    "ultimate-jekyll-manager": "0.0.127"
  },
  "config": {
    "source": "dist",
    "destination": "/home/runner/work/instagrowify-website/instagrowify-website/_site",
    "collections_dir": "",
    ...
    "meta": {
      "title": "Instagram Bot - Get real followers, likes, and comments - {{ site.brand.name }}",
      "description": "Automate your Instagram activity with this free like bot, follow bot, & comment bot. {{ site.brand.name }} is a follow bot and video view generator all in one. Increase Instagram followers for free!",
    ...
    "brand": {
      "id": "somiibo",
      "name": "Instagrowify",
      "description": "Automate Instagram growth and engagement",
      "type": "Corporation",
      "images": {
    ...
    "cloudflare": {
      "zone": "d0a47ec9c9c89c549852a7782bfb4324"
    },
    "download": {
      "mac": {
        "universal": ""
    ...
    "random_id": 25,
    "canonical": {
      "url": "https://instagrowify.com/config.json",
      "path": "/config.json"
    }
  },
  "npm-build": "2025-12-03T04:43:18.988Z"
};
